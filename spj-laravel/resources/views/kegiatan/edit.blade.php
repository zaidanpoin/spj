            ...
            <form action="{{ route('kegiatan.update', $kegiatan->id) }}" method="POST" enctype="multipart/form-data" class="p-4 sm:p-6 space-y-4">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="nomor_bukti_konsumsi" value="{{ old('nomor_bukti_konsumsi', $kegiatan->nomor_bukti_konsumsi) }}"
                    ...
                    <div>
                        ...
                        <input type="text" name="nomor_bukti_profesi" value="{{ old('nomor_bukti_profesi', $kegiatan->nomor_bukti_profesi) }}"
